...
export function leerSuperheroes(ruta) {
    ...
    //Función para agregar nuevos superhéroes
    export function agregarSuperheroes(rutaOriginal, rutaNuevos) {
        ...
        // Combinar listas y ordenar por ID
        const listaActualizada = [...superheroesOriginales, ...instanciasNuevos].sort((a, b) => a.id - b.id);
